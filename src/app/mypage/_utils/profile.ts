...
// // hooks/useUpdateProfileImage.ts
// import { createClient } from "@/lib/utils/supabase/client";
...
//           ? error
//           : new Error(
//               "프로필 이미지 업데이트 중 알 수 없는 오류가 발생했습니다.",
//             );
//       }
//     },
//     onSuccess: (data: UpdateProfileImageResponse) => {
//       queryClient.invalidateQueries({ queryKey: ["userInfo"] });
//       console.log("프로필 이미지가 성공적으로 업데이트되었습니다.");
//     },
//     onError: (error: Error) => {
//       console.error("프로필 이미지 업데이트 중 오류:", error);
//       alert(error.message || "프로필 이미지 업데이트 중 오류가 발생했습니다.");
//     },
//   });
// };
