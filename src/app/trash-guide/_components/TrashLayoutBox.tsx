...
const TrashLayoutBox = ({ isWasteDay }: { isWasteDay: boolean }) => {
  return (
    <div
      className={clsx(
        "relative min-h-[500px] rounded bg-white p-5 pb-14 shadow-custom lg:h-[calc(100vh-280px)]",
        {
          "pb-0": !isWasteDay,
        },
      )}
    >
      ...
      <h2 className="common-title mb-6 pt-3 text-center [text-rendering:optimizeLegibility]">
        {isWasteDay ? (
          <>
            지역별 쓰레기 <br /> 배출 요일 확인
          </>
