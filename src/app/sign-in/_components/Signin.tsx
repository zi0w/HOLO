      ...
      <div className="mx-5 flex flex-col items-center pb-5">
        <form onSubmit={handleLogin} className="w-full">
          <div className="w-full">
            <div className="space-y-[8px]">
              <div>
                <input
                  ...
                  className="h-[56px] w-[362px] rounded-[4px] border border-[#999E98] bg-[#F8F9FA] px-4 text-[14px] placeholder:text-[#999] valid:bg-[#F8F9FA] focus:outline-none"
                  required
                />
                {errors.email && (
            ...
            <button
              type="submit"
              className={`mt-[24px] h-[48px] w-[362px] rounded-[4px] text-[16px] font-medium text-white ${
