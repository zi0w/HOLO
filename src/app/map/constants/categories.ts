...
export const MAP_CATEGORIES = [
  ...
  { id: 10, name: "부동산", img: Property },
  { id: 11, name: "카센터", img: Garage },
  { id: 12, name: "PC방", img: Pcbang },
];
