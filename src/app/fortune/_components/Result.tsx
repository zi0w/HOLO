...
const Result = () => {
  ...
  return fortune ? (
    <div
      id="result-container"
      className="flex flex-col items-center bg-white text-black mt-4 lg:border lg:mt-40 lg:max-w-lg lg:mx-auto lg:border-primary-500 lg:rounded-3xl"
    >
      <Image
        src={Fortune}
        alt="result-fortune"
      ...
      {id ? (
        ...
        <>
          ...
          <div className="mt-6 flex gap-4 pb-4">
            ...
            <ShareButton postUrl={shareLink} title="포춘쿠키 내용" description={fortune} thumbnail={Fortune.src} />
          </div>
    ...
    <div className="flex h-screen items-center justify-center flex-col gap-4 lg:border lg:mt-40 lg:max-w-lg lg:mx-auto lg:border-primary-500 lg:rounded-3xl lg:max-h-[700px]">
      <Loading />
